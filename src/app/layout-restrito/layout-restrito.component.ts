...
export class LayoutRestritoComponent {
  ...
  ngOnInit(): void {
    ...
    this.movimentacaoService.listarAlertas().subscribe((alertas) => {
      console.log(alertas);
      this.alertas = alertas;
      this.quantidadeAlertas = alertas.length;
    });
  ...
  getIniciais(nome: string | undefined, sobrenome: string | undefined): string {
    ...
    const inicialSobrenome = sobrenome ? sobrenome[0] : '';
    return (inicialNome + inicialSobrenome).toUpperCase();
  }
